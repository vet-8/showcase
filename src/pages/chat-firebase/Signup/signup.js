        ...
        <Paper className={classes.paper}>
          ...
          <form onSubmit={(e) => this.submitSignup(e)} className={classes.form}>
            <FormControl required fullWidth margin='normal'>
              <InputLabel htmlFor='signup-fullname-input'>Enter Your Fullname</InputLabel>
              <Input autoComplete='fullname' autoFocus onChange={(e) => this.userTyping('fullname', e)} id='signup-fullname-input'></Input>
            </FormControl>
            <FormControl required fullWidth margin='normal'>
